  ...
  <h2>Php Crud</h2>
    <div class="container">
        ...
        <div class="form-group">
          ...
          <input type="text"
            class="form-control" name="salary" id="" aria-describedby="helpId" placeholder="">
          <small id="helpId" class="form-text text-muted">Help text</small>
        </div>
        <div class="form-group">
          <label for="">Batch</label>
          <input type="text"
            class="form-control" name="batch" id="" aria-describedby="helpId" placeholder="">
          <small id="helpId" class="form-text text-muted">Help text</small>
        </div>
        <div class="form-group">
...
if(isset($_POST['submit'])){
    ...
    $insert = $con->query("INSERT INTO `teacher`(`name`,`picture`, `email`, `address`,`salary`,`batch`)
     VALUES ('$name','$targetfile','$email','$address','$salary','$batch')");
