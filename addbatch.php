  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="form-group">
          ...
          <input type="text"
            class="form-control" name="bname" id=""  aria-describedby="helpId" placeholder="">
          <small id="helpId" class="form-text text-muted">Help text</small>
        </div>
        <div class="form-group">
          <label for="">Assign Faculty</label>
...
if(isset($_POST['submit'])){
    ...
    $insert = $con->query("INSERT INTO `batch`(`bname`,`tname`) VALUES ('$bname','$tname')");
